...
{ 
    /// <summary>
    /// A unique identifier for an event which consists of ID and, in the case of recurring event instances, date.
    /// </summary>
    [DataContract]
    public class EventIdentifier : IEquatable<EventIdentifier>
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EventIdentifier {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((EventIdentifier)obj);
        }

        /// <summary>
        /// Returns true if EventIdentifier instances are equal
        /// </summary>
        /// <param name="other">Instance of EventIdentifier to be compared</param>
        /// <returns>Boolean</returns>
